...
-- Дамп данных таблицы konoha.chat_u2u: ~0 rows (приблизительно)
...
-- Дамп данных таблицы konoha.comments: ~0 rows (приблизительно)
...
-- Дамп данных таблицы konoha.likes: ~0 rows (приблизительно)
...
-- Дамп данных таблицы konoha.posts: ~0 rows (приблизительно)
...
-- Дамп данных таблицы konoha.users: ~0 rows (приблизительно)
...
-- Дамп данных таблицы konoha.user_subscription: ~0 rows (приблизительно)
